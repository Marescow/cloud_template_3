...
CREATE INDEX billingeventRelIDX_6307 ON abstractbundlerules (p_billingevent);
...
(
    ...
    p_cpqcharacteristicname NVARCHAR(255),
    p_cpqcharacteristicassignedval LONGVARCHAR,
    PRIMARY KEY (PK)
);
...
(
    ...
    p_city BIGINT,
    p_citydistrict BIGINT,
    p_fullname NVARCHAR(255),
    p_latitude DOUBLE,
    p_longitude DOUBLE,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
...
(
    ...
    p_topvaluessize INTEGER,
    p_sort NVARCHAR(255),
    p_ranged TINYINT,
    p_rangeincludefrom TINYINT,
    p_rangeincludeto TINYINT,
    p_uniqueidx NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    p_searchconfigurationpos INTEGER,
...
CREATE CACHED TABLE asfacetconflp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE asfacetrange
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX versionIdx_2250 ON asfacetrange (p_catalogversion);

CREATE UNIQUE INDEX uidIdx_2250 ON asfacetrange (p_catalogversion, p_uid);

CREATE UNIQUE INDEX uniqueIdx_2250 ON asfacetrange (p_catalogversion, p_uniqueidx);

CREATE INDEX facetconfigurationRelIDX_2250 ON asfacetrange (p_facetconfiguration);

CREATE INDEX facetconfigurationposPosIDX_2250 ON asfacetrange (p_facetconfigurationpos);


CREATE CACHED TABLE asfacetrange2250sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2250Sn ON asfacetrange2250sn (ITEMPK);


CREATE CACHED TABLE asfacetrangelp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
(
    ...
    p_groupmergemode BIGINT,
    p_groupexpression NVARCHAR(255),
...
CREATE CACHED TABLE b2bcustomercred10038sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_10038Sn ON b2bcustomercred10038sn (ITEMPK);


CREATE CACHED TABLE b2bcustomercredential
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE b2bdocument
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_documentnumber NVARCHAR(255),
    p_status BIGINT,
    p_date TIMESTAMP,
    p_duedate TIMESTAMP,
    p_amount DECIMAL(30,8),
    p_openamount DECIMAL(30,8),
    p_currency BIGINT,
    p_documentmedia BIGINT,
...
CREATE INDEX documenttypeRelIDX_11100 ON b2bdocument (p_documenttype);

CREATE INDEX unitRelIDX_11100 ON b2bdocument (p_unit);

CREATE INDEX orderRelIDX_11100 ON b2bdocument (p_order);


CREATE CACHED TABLE b2bdocument11100sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_11100Sn ON b2bdocument11100sn (ITEMPK);


CREATE CACHED TABLE b2bdocumentpaym11103sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_11103Sn ON b2bdocumentpaym11103sn (ITEMPK);


CREATE CACHED TABLE b2bdocumentpaymentinfo
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_external NVARCHAR(255),
    p_amount DECIMAL(30,8),
    p_date TIMESTAMP,
    p_cctransactionnumber NVARCHAR(255),
    p_paydocument BIGINT,
    p_usedocument BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE INDEX paydocumentRelIDX_11103 ON b2bdocumentpaymentinfo (p_paydocument);

CREATE INDEX usedocumentRelIDX_11103 ON b2bdocumentpaymentinfo (p_usedocument);


CREATE CACHED TABLE b2bdocumenttype
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_code NVARCHAR(255),
    p_includeinopenbalance TINYINT,
    p_displayinalllist TINYINT,
    p_payableorusable BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE b2bdocumenttype11101sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_11101Sn ON b2bdocumenttype11101sn (ITEMPK);


CREATE CACHED TABLE b2bdocumenttypelp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE b2bregistration
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_telephone NVARCHAR(255),
    p_telephoneextension NVARCHAR(255),
    p_companyname NVARCHAR(255),
    p_companyaddressstreet NVARCHAR(255),
    p_companyaddressstreetline2 NVARCHAR(255),
    p_companyaddresscity NVARCHAR(255),
    p_companyaddresspostalcode NVARCHAR(255),
    p_companyaddressregion BIGINT,
    p_companyaddresscountry BIGINT,
    p_message LONGVARCHAR,
    p_rejectreason NVARCHAR(255),
...
CREATE CACHED TABLE b2bregistration10040sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_10040Sn ON b2bregistration10040sn (ITEMPK);
...
CREATE CACHED TABLE backofficecolle13219sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_13219Sn ON backofficecolle13219sn (ITEMPK);


CREATE CACHED TABLE backofficecollections
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX userRelIDX_13219 ON backofficecollections (p_user);


CREATE CACHED TABLE backofficecolli13218sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_13218Sn ON backofficecolli13218sn (ITEMPK);


CREATE CACHED TABLE backofficecollitemrefs
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_product BIGINT,
    p_collectionpk BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE INDEX itemIDX_13218 ON backofficecollitemrefs (p_product);

CREATE INDEX collectionpkRelIDX_13218 ON backofficecollitemrefs (p_collectionpk);
...
(
    ...
    p_savedqueriesparameters LONGVARBINARY,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE basestoreforcpq9910sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9910Sn ON basestoreforcpq9910sn (ITEMPK);

CREATE INDEX IdxsourcePK_9910Sn ON basestoreforcpq9910sn (sourcePK);

CREATE INDEX IdxtargetPK_9910Sn ON basestoreforcpq9910sn (targetPK);

CREATE INDEX IdxlanguagePK_9910Sn ON basestoreforcpq9910sn (languagePK);


CREATE CACHED TABLE basestoreforcpqrule
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX linktarget_9910 ON basestoreforcpqrule (TargetPK);

CREATE INDEX rseqnr_9910 ON basestoreforcpqrule (RSequenceNumber);

CREATE INDEX qualifier_9910 ON basestoreforcpqrule (Qualifier);

CREATE INDEX linksource_9910 ON basestoreforcpqrule (SourcePK);

CREATE INDEX seqnr_9910 ON basestoreforcpqrule (SequenceNumber);
...
CREATE CACHED TABLE billingfrequenc6304sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6304Sn ON billingfrequenc6304sn (ITEMPK);


CREATE CACHED TABLE billingfrequency
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE UNIQUE INDEX codeIdx_6304 ON billingfrequency (p_code);


CREATE CACHED TABLE billingfrequencylp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
    p_nameincart NVARCHAR(255),
    p_nameinorder NVARCHAR(255),
    p_description NVARCHAR(255),
    PRIMARY KEY (ITEMPK, LANGPK)
);


CREATE CACHED TABLE billingplans
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_id NVARCHAR(255),
    p_billingcycleday INTEGER,
    p_billingcycletype BIGINT,
    p_billingfrequency BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE billingplans6324sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6324Sn ON billingplans6324sn (ITEMPK);


CREATE CACHED TABLE billingplanslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE boidxtype2srhsv6703sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6703Sn ON boidxtype2srhsv6703sn (ITEMPK);


CREATE CACHED TABLE boidxtype2srhsvcindexcfg
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_indexedtype BIGINT,
    p_snindexconfiguration BIGINT,
    p_snindextype BIGINT,
    p_active TINYINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE UNIQUE INDEX uniqueIdx_6703 ON boidxtype2srhsvcindexcfg (p_indexedtype, p_snindexconfiguration, p_snindextype);
...
(
    ...
    p_costcenter BIGINT,
    p_xmlproduct LONGVARCHAR,
    p_originalsubscriptionid NVARCHAR(255),
    p_originalorderentry BIGINT,
    p_masterentry BIGINT,
    p_cpqstatussummarymap LONGVARBINARY,
    p_productconfiguration BIGINT,
    p_productconfigurationdraft BIGINT,
    p_addtocarttime TIMESTAMP,
...
CREATE INDEX masterentryRelIDX_44 ON cartentries (p_masterentry);
...
(
    ...
    p_appliedvouchercodes LONGVARBINARY,
    ...
    p_processingflashbuyorder TINYINT,
    p_visible TINYINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE INDEX parentRelIDX_43 ON carts (p_parent);
...
CREATE CACHED TABLE chargeentries
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    propTS BIGINT DEFAULT 0,
    p_billingevent BIGINT,
    p_subscriptionpriceplanonetime BIGINT,
    p_cyclestart INTEGER,
    p_cycleend INTEGER,
    p_subscriptionpriceplanrecurri BIGINT,
    p_usagecharge BIGINT,
    p_tierstart INTEGER,
    p_tierend INTEGER,
    PRIMARY KEY (PK)
);

CREATE INDEX versionIdx_6320 ON chargeentries (p_catalogversion);

CREATE INDEX idVersionIdx_6320 ON chargeentries (p_id, p_catalogversion);

CREATE INDEX subscriptionpriceplanonetimeRelIDX_6320 ON chargeentries (p_subscriptionpriceplanonetime);

CREATE INDEX subscriptionpriceplanrecurriRelIDX_6320 ON chargeentries (p_subscriptionpriceplanrecurri);

CREATE INDEX usagechargeRelIDX_6320 ON chargeentries (p_usagecharge);


CREATE CACHED TABLE chargeentries6320sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6320Sn ON chargeentries6320sn (ITEMPK);


CREATE CACHED TABLE chargeentrieslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE INDEX ISOCode_9860 ON cities (p_isocode);

CREATE INDEX regionRelIDX_9860 ON cities (p_region);

CREATE INDEX regionposPosIDX_9860 ON cities (p_regionpos);


CREATE CACHED TABLE cities9860sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9860Sn ON cities9860sn (ITEMPK);


CREATE CACHED TABLE citieslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE classfeaturegro7510sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_7510Sn ON classfeaturegro7510sn (ITEMPK);


CREATE CACHED TABLE classfeaturegroup
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_code NVARCHAR(255),
    p_classificationclasspos INTEGER,
    p_classificationclass BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE INDEX classificationclassRelIDX_7510 ON classfeaturegroup (p_classificationclass);

CREATE INDEX classificationclassposPosIDX_7510 ON classfeaturegroup (p_classificationclasspos);


CREATE CACHED TABLE classfeaturegrouplp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
(
    ...
    p_name NVARCHAR(255),
    p_catalogversion BIGINT,
    p_synchronizationblocked TINYINT,
    p_visible TINYINT,
    p_onlyonerestrictionmustapply TINYINT,
    p_styleclasses NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    p_scope BIGINT,
    p_defaultcmscomponent BIGINT,
    p_sourceid NVARCHAR(255),
    p_groupstartlevel INTEGER,
    p_showsummary TINYINT,
    p_showonlyforlongconfiguration TINYINT,
    p_showpricedetails TINYINT,
    p_external TINYINT,
    p_url NVARCHAR(255),
    p_target BIGINT,
    ...
    p_listviewpagesize INTEGER,
    p_gridviewpagesize INTEGER,
...
CREATE UNIQUE INDEX cmsItemByUidCvIDX_1084 ON cmscomponent (p_uid, p_catalogversion);

CREATE INDEX componentSearchIDX_1084 ON cmscomponent (TypePkString, p_catalogversion, p_name);
...
CREATE CACHED TABLE cmsitemtypeattr1105sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1105Sn ON cmsitemtypeattr1105sn (ITEMPK);


CREATE CACHED TABLE cmsitemtypeattrfltcfg
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_typecode NVARCHAR(255),
    p_mode NVARCHAR(255),
    p_attributes NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE UNIQUE INDEX attributeUniqueIndex_1105 ON cmsitemtypeattrfltcfg (p_typecode, p_mode);
...
CREATE UNIQUE INDEX cmsItemByUidCvIDX_1096 ON cmsnavigationentry (p_uid, p_catalogversion);
...
CREATE UNIQUE INDEX cmsItemByUidCvIDX_1088 ON cmsnavigationnode (p_uid, p_catalogversion);
...
CREATE UNIQUE INDEX cmsItemByUidCvIDX_1072 ON cmspage (p_uid, p_catalogversion);
...
CREATE UNIQUE INDEX cmsRelationByUidCvIdx_1100 ON cmsrelations (p_uid, p_catalogversion);
...
(
    ...
    sealed TINYINT,
    p_uid NVARCHAR(255),
    p_requiresauthentication TINYINT,
    p_theme BIGINT,
    p_defaultlanguage BIGINT,
    p_channel BIGINT,
    ...
    p_defaultcontentcatalog BIGINT,
...
CREATE CACHED TABLE cockpitcollecti1700sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1700Sn ON cockpitcollecti1700sn (ITEMPK);
...
CREATE CACHED TABLE cockpitcollelem1701sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1701Sn ON cockpitcollelem1701sn (ITEMPK);
...
CREATE CACHED TABLE cockpitcollitem1702sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1702Sn ON cockpitcollitem1702sn (ITEMPK);
...
CREATE CACHED TABLE cockpitcompacce1708sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1708Sn ON cockpitcompacce1708sn (ITEMPK);
...
CREATE CACHED TABLE cockpitcompconf1707sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1707Sn ON cockpitcompconf1707sn (ITEMPK);
...
CREATE CACHED TABLE cockpitfavcateg1718sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1718Sn ON cockpitfavcateg1718sn (ITEMPK);
...
CREATE CACHED TABLE cockpititemtemp24242sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_24242Sn ON cockpititemtemp24242sn (ITEMPK);
...
CREATE CACHED TABLE cockpitsavedfac1704sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1704Sn ON cockpitsavedfac1704sn (ITEMPK);
...
CREATE CACHED TABLE cockpitsavedpar1706sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1706Sn ON cockpitsavedpar1706sn (ITEMPK);
...
CREATE CACHED TABLE cockpitsavedque1703sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1703Sn ON cockpitsavedque1703sn (ITEMPK);
...
CREATE CACHED TABLE cockpitsavedsor1705sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1705Sn ON cockpitsavedsor1705sn (ITEMPK);
...
CREATE CACHED TABLE cockpittemplcla1713sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1713Sn ON cockpittemplcla1713sn (ITEMPK);

CREATE INDEX IdxsourcePK_1713Sn ON cockpittemplcla1713sn (sourcePK);

CREATE INDEX IdxtargetPK_1713Sn ON cockpittemplcla1713sn (targetPK);

CREATE INDEX IdxlanguagePK_1713Sn ON cockpittemplcla1713sn (languagePK);
...
CREATE CACHED TABLE commentmetadata1716sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1716Sn ON commentmetadata1716sn (ITEMPK);
...
CREATE CACHED TABLE components4comp1126sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1126Sn ON components4comp1126sn (ITEMPK);

CREATE INDEX IdxsourcePK_1126Sn ON components4comp1126sn (sourcePK);

CREATE INDEX IdxtargetPK_1126Sn ON components4comp1126sn (targetPK);

CREATE INDEX IdxlanguagePK_1126Sn ON components4comp1126sn (languagePK);


CREATE CACHED TABLE components4components
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX linktarget_1126 ON components4components (TargetPK);

CREATE INDEX rseqnr_1126 ON components4components (RSequenceNumber);

CREATE INDEX qualifier_1126 ON components4components (Qualifier);

CREATE INDEX linksource_1126 ON components4components (SourcePK);

CREATE INDEX seqnr_1126 ON components4components (SequenceNumber);
...
CREATE UNIQUE INDEX componentTypeGroupByCodeIDX_1098 ON componenttypegrp (p_code);
...
CREATE UNIQUE INDEX cmsItemByUidCvIDX_1066 ON contentslot (p_uid, p_catalogversion);
...
(
    ...
    p_agent BIGINT,
    p_customer BIGINT,
    p_closetime TIMESTAMP,
    p_messages LONGVARCHAR,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE conversations9874sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9874Sn ON conversations9874sn (ITEMPK);


CREATE CACHED TABLE conversionerror403sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_403Sn ON conversionerror403sn (ITEMPK);
...
CREATE CACHED TABLE conversiongroup401sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_401Sn ON conversiongroup401sn (ITEMPK);
...
(
    ...
    p_rule BIGINT,
    p_maxproductquantityperorder INTEGER,
    p_product BIGINT,
    p_originalmaxorderquantity INTEGER,
...
CREATE CACHED TABLE couponnotificat9872sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9872Sn ON couponnotificat9872sn (ITEMPK);


CREATE CACHED TABLE couponnotification
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE UNIQUE INDEX IdxCouponNotification_9872 ON couponnotification (p_customer, p_customercoupon);
...
(
    ...
    p_lastsuccessfulstarttime TIMESTAMP,
    p_indextypepos INTEGER,
    p_indextype BIGINT,
    p_indexeritemsource BIGINT,
    ...
    p_numberofday INTEGER,
    p_documentstatuslist LONGVARCHAR,
    p_documenttypelist LONGVARCHAR,
    p_queuetimelimit INTEGER,
    p_sites LONGVARCHAR,
    p_cartremovalage INTEGER,
    p_anonymouscartremovalage INTEGER,
    p_age INTEGER,
    p_thresholddays INTEGER,
    p_cleanupmode BIGINT,
    p_basesite BIGINT,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE cuscoupon2cus
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX linktarget_9869 ON cuscoupon2cus (TargetPK);

CREATE INDEX rseqnr_9869 ON cuscoupon2cus (RSequenceNumber);

CREATE INDEX qualifier_9869 ON cuscoupon2cus (Qualifier);

CREATE INDEX linksource_9869 ON cuscoupon2cus (SourcePK);

CREATE INDEX seqnr_9869 ON cuscoupon2cus (SequenceNumber);


CREATE CACHED TABLE cuscoupon2cus9869sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9869Sn ON cuscoupon2cus9869sn (ITEMPK);

CREATE INDEX IdxsourcePK_9869Sn ON cuscoupon2cus9869sn (sourcePK);

CREATE INDEX IdxtargetPK_9869Sn ON cuscoupon2cus9869sn (targetPK);

CREATE INDEX IdxlanguagePK_9869Sn ON cuscoupon2cus9869sn (languagePK);


CREATE CACHED TABLE cuscouponforrul9870sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9870Sn ON cuscouponforrul9870sn (ITEMPK);


CREATE CACHED TABLE cuscouponforrules
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_customercouponcode NVARCHAR(255),
    p_rule BIGINT,
    p_promotion BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
...
CREATE INDEX CusCouponForRule_IDX_9870 ON cuscouponforrules (p_customercouponcode, p_rule);


CREATE CACHED TABLE customercoupons
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_enddate TIMESTAMP,
    p_active TINYINT,
    p_assignable TINYINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE UNIQUE INDEX UC_Coupon_9871 ON customercoupons (p_couponid);


CREATE CACHED TABLE customercoupons9871sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9871Sn ON customercoupons9871sn (ITEMPK);


CREATE CACHED TABLE customercouponslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
(
    ...
    p_inboundchannelconfigurationp INTEGER,
    p_inboundchannelconfiguration BIGINT,
    PRIMARY KEY (PK)
);
...
CREATE INDEX inboundchannelconfigurationRelIDX_6611 ON destinations (p_inboundchannelconfiguration);

CREATE INDEX inboundchannelconfigurationpPosIDX_6611 ON destinations (p_inboundchannelconfigurationp);
...
CREATE INDEX ISOCode_9861 ON districts (p_isocode);

CREATE INDEX cityRelIDX_9861 ON districts (p_city);

CREATE INDEX cityposPosIDX_9861 ON districts (p_citypos);


CREATE CACHED TABLE districts9861sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9861Sn ON districts9861sn (ITEMPK);


CREATE CACHED TABLE districtslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
(
    ...
    p_sourcerule BIGINT,
    p_promotion BIGINT,
    p_messageseverity BIGINT,
    p_messageforcstic NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
...
CREATE CACHED TABLE entitlements
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE entitlements6321sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6321Sn ON entitlements6321sn (ITEMPK);


CREATE CACHED TABLE entitlementslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE featuregroupass7511sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_7511Sn ON featuregroupass7511sn (ITEMPK);


CREATE CACHED TABLE featuregroupassignment
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_classificationclass BIGINT,
    p_classfeaturegrouppos INTEGER,
    p_classfeaturegroup BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE INDEX classfeaturegroupRelIDX_7511 ON featuregroupassignment (p_classfeaturegroup);

CREATE INDEX classfeaturegroupposPosIDX_7511 ON featuregroupassignment (p_classfeaturegrouppos);


CREATE CACHED TABLE flashbuycronjob9873sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9873Sn ON flashbuycronjob9873sn (ITEMPK);


CREATE CACHED TABLE flashbuycronjobs
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_currentretry INTEGER,
    p_job BIGINT,
    p_flashbuycoupon BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE INDEX IdxJob_9873 ON flashbuycronjobs (p_job);

CREATE INDEX IdxNode_9873 ON flashbuycronjobs (p_nodeid);

CREATE INDEX IdxActive_9873 ON flashbuycronjobs (p_active);
...
(
    ...
    p_code NVARCHAR(255),
    p_visualisationx INTEGER,
    p_visualisationy INTEGER,
    p_qualifier NVARCHAR(255),
...
CREATE CACHED TABLE inboundchannelc8410sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8410Sn ON inboundchannelc8410sn (ITEMPK);


CREATE CACHED TABLE inboundchannelconf
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_authenticationtype BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE UNIQUE INDEX idx_inboundChannelConfigurationIo_8410 ON inboundchannelconf (p_integrationobject);
...
CREATE CACHED TABLE intclientcredde8411sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8411Sn ON intclientcredde8411sn (ITEMPK);


CREATE CACHED TABLE intclientcreddetails
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE UNIQUE INDEX clientIdIdx_8411 ON intclientcreddetails (p_clientid);
...
CREATE UNIQUE INDEX idx_integrationObjectItemAttributeNameIntegrationObjectItem_8402 ON integrationobjitemattrs (p_attributename, p_integrationobjectitem);
...
CREATE CACHED TABLE intobjitemclass8409sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8409Sn ON intobjitemclass8409sn (ITEMPK);


CREATE CACHED TABLE intobjitemclassattrs
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE UNIQUE INDEX idx_integrationObjectItemClassificationAttributeNameIntegrationObjectItem_8409 ON intobjitemclassattrs (p_attributename, p_integrationobjectitem);

CREATE INDEX integrationobjectitemRelIDX_8409 ON intobjitemclassattrs (p_integrationobjectitem);


CREATE CACHED TABLE intobjitemvirtu8412sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8412Sn ON intobjitemvirtu8412sn (ITEMPK);


CREATE CACHED TABLE intobjitemvirtualattrs
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE UNIQUE INDEX idx_integrationObjectItemVirtualAttributeNameIntegrationObjectItem_8412 ON intobjitemvirtualattrs (p_attributename, p_integrationobjectitem);

CREATE INDEX integrationobjectitemRelIDX_8412 ON intobjitemvirtualattrs (p_integrationobjectitem);


CREATE CACHED TABLE intobjvirtattrd8413sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8413Sn ON intobjvirtattrd8413sn (ITEMPK);


CREATE CACHED TABLE intobjvirtattrdescrs
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE UNIQUE INDEX idx_integrationObjectVirtualAttributeDescriptorCode_8413 ON intobjvirtattrdescrs (p_code);
...
CREATE CACHED TABLE itemcockpittemp1712sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1712Sn ON itemcockpittemp1712sn (ITEMPK);

CREATE INDEX IdxsourcePK_1712Sn ON itemcockpittemp1712sn (sourcePK);

CREATE INDEX IdxtargetPK_1712Sn ON itemcockpittemp1712sn (targetPK);

CREATE INDEX IdxlanguagePK_1712Sn ON itemcockpittemp1712sn (languagePK);
...
(
    ...
    p_output BIGINT,
    p_input BIGINT,
    p_streamconfigurationcontainer BIGINT,
    p_maxthreads INTEGER,
...
CREATE UNIQUE INDEX codeVersionIDX_602 ON keywords (p_keyword, p_catalogversion, p_language);
...
CREATE CACHED TABLE mediaconttypefo402sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_402Sn ON mediaconttypefo402sn (ITEMPK);

CREATE INDEX IdxsourcePK_402Sn ON mediaconttypefo402sn (sourcePK);

CREATE INDEX IdxtargetPK_402Sn ON mediaconttypefo402sn (targetPK);

CREATE INDEX IdxlanguagePK_402Sn ON mediaconttypefo402sn (languagePK);
...
CREATE CACHED TABLE mediametadata400sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_400Sn ON mediametadata400sn (ITEMPK);
...
CREATE CACHED TABLE merchsynchroniz2510sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2510Sn ON merchsynchroniz2510sn (ITEMPK);


CREATE CACHED TABLE merchsynchronization
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_operationid NVARCHAR(255),
    p_config BIGINT,
    p_type NVARCHAR(255),
    p_status NVARCHAR(255),
    p_starttime TIMESTAMP,
    p_endtime TIMESTAMP,
    p_numberofproducts BIGINT,
    p_details LONGVARCHAR,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE UNIQUE INDEX operationIdIdx_2510 ON merchsynchronization (p_operationid);
...
CREATE INDEX masterentryRelIDX_46 ON orderentries (p_masterentry);
...
CREATE CACHED TABLE orderform17001sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_17001Sn ON orderform17001sn (ITEMPK);


CREATE CACHED TABLE orderformentry
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE orderformentry17002sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_17002Sn ON orderformentry17002sn (ITEMPK);
...
CREATE INDEX parentRelIDX_45 ON orders (p_parent);
...
CREATE CACHED TABLE outboundchannel8407sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8407Sn ON outboundchannel8407sn (ITEMPK);


CREATE CACHED TABLE outboundchannelconf
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_autogenerate TINYINT,
    p_synchronizedelete TINYINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE UNIQUE INDEX idx_outboundChannelConfigurationCode_8407 ON outboundchannelconf (p_code);
...
CREATE CACHED TABLE outboundsyncret8408sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8408Sn ON outboundsyncret8408sn (ITEMPK);


CREATE CACHED TABLE outboundsyncretry
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_itempk BIGINT,
    p_channel BIGINT,
    p_syncattempts INTEGER,
    p_remainingsyncattempts INTEGER,
    p_reachedmaxretries TINYINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE UNIQUE INDEX idx_outboundSyncRetryItemPkChannel_8408 ON outboundsyncretry (p_itempk, p_channel);
...
CREATE UNIQUE INDEX cmsItemByUidCvIDX_1076 ON pagetemplate (p_uid, p_catalogversion);
...
CREATE CACHED TABLE patchexecutions
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_patchid NVARCHAR(255),
    p_patchname NVARCHAR(255),
    p_patchdescription NVARCHAR(255),
    p_executiontime TIMESTAMP,
    p_previousexecution BIGINT,
    p_nextexecution BIGINT,
    p_jenkinsbuild NVARCHAR(255),
    p_githashcode NVARCHAR(255),
    p_executionstatus BIGINT,
    p_errorlog LONGVARCHAR,
    p_rerunnable TINYINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE patchexecutions9460sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9460Sn ON patchexecutions9460sn (ITEMPK);


CREATE CACHED TABLE patchexecutionu9461sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9461Sn ON patchexecutionu9461sn (ITEMPK);


CREATE CACHED TABLE patchexecutionunits
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_idhash NVARCHAR(255),
    p_name NVARCHAR(255),
    p_ordernumber INTEGER,
    p_organisation NVARCHAR(255),
    p_executionstatus BIGINT,
    p_executiontype BIGINT,
    p_executiontime TIMESTAMP,
    p_contenthash NVARCHAR(255),
    p_errorlog LONGVARCHAR,
    p_cronjob BIGINT,
    p_patch BIGINT,
    aCLTS BIGINT DEFAULT 0,
...
(
    ...
    p_activecatalogversion BIGINT,
    p_version BIGINT,
    p_previewcontentcatalogversion BIGINT,
...
CREATE CACHED TABLE pricerowslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE principcockpitr1714sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1714Sn ON principcockpitr1714sn (ITEMPK);

CREATE INDEX IdxsourcePK_1714Sn ON principcockpitr1714sn (sourcePK);

CREATE INDEX IdxtargetPK_1714Sn ON principcockpitr1714sn (targetPK);

CREATE INDEX IdxlanguagePK_1714Sn ON principcockpitr1714sn (languagePK);
...
CREATE CACHED TABLE principcockpitw1715sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1715Sn ON principcockpitw1715sn (ITEMPK);

CREATE INDEX IdxsourcePK_1715Sn ON principcockpitw1715sn (sourcePK);

CREATE INDEX IdxtargetPK_1715Sn ON principcockpitw1715sn (targetPK);

CREATE INDEX IdxlanguagePK_1715Sn ON principcockpitw1715sn (languagePK);
...
(
    ...
    p_registration BIGINT,
    p_passwordresettoken NVARCHAR(255),
    p_rejectreason NVARCHAR(255),
    p_uploadedfile BIGINT,
    p_savedcart BIGINT,
    p_carttoordercronjob BIGINT,
    p_quotecode NVARCHAR(255),
    p_tokencode NVARCHAR(255),
    p_target NVARCHAR(255),
...
CREATE CACHED TABLE product2product9912sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9912Sn ON product2product9912sn (ITEMPK);

CREATE INDEX IdxsourcePK_9912Sn ON product2product9912sn (sourcePK);

CREATE INDEX IdxtargetPK_9912Sn ON product2product9912sn (targetPK);

CREATE INDEX IdxlanguagePK_9912Sn ON product2product9912sn (languagePK);


CREATE CACHED TABLE product2productconfigs
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX linktarget_9912 ON product2productconfigs (TargetPK);

CREATE INDEX rseqnr_9912 ON product2productconfigs (RSequenceNumber);

CREATE INDEX qualifier_9912 ON product2productconfigs (Qualifier);

CREATE INDEX linksource_9912 ON product2productconfigs (SourcePK);

CREATE INDEX seqnr_9912 ON product2productconfigs (SequenceNumber);


CREATE CACHED TABLE productconfigur9911sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9911Sn ON productconfigur9911sn (ITEMPK);


CREATE CACHED TABLE productconfiguration
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_configurationid NVARCHAR(255),
    p_version NVARCHAR(255),
    p_usersessionid NVARCHAR(255),
    p_kbname NVARCHAR(255),
    p_kbversion NVARCHAR(255),
    p_kblogsys NVARCHAR(255),
    p_user BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE UNIQUE INDEX configurationIdIdx_9911 ON productconfiguration (p_configurationid);

CREATE INDEX userSessionIdx_9911 ON productconfiguration (p_usersessionid);

CREATE INDEX userRelIDX_9911 ON productconfiguration (p_user);
...
CREATE CACHED TABLE productentitlem6329sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6329Sn ON productentitlem6329sn (ITEMPK);


CREATE CACHED TABLE productentitlements
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_catalogversion BIGINT,
    p_timeunit BIGINT,
    p_timeunitstart INTEGER,
    p_timeunitduration INTEGER,
    p_conditionstring NVARCHAR(255),
    p_conditionpath NVARCHAR(255),
    p_conditiongeo LONGVARBINARY,
    p_quantity INTEGER,
    p_subscriptionproduct BIGINT,
...
CREATE INDEX subscriptionproductRelIDX_6329 ON productentitlements (p_subscriptionproduct);

CREATE INDEX entitlementRelIDX_6329 ON productentitlements (p_entitlement);


CREATE CACHED TABLE productentitlementslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
(
    ...
    p_subscriptionterm BIGINT,
    p_sequenceid BIGINT,
    p_unspcs NVARCHAR(255),
...
CREATE INDEX subscriptiontermRelIDX_1 ON products (p_subscriptionterm);
...
CREATE CACHED TABLE punchoutcredent10039sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_10039Sn ON punchoutcredent10039sn (ITEMPK);


CREATE CACHED TABLE punchoutcredential
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_code NVARCHAR(255),
    p_identity NVARCHAR(255),
    p_domain NVARCHAR(255),
    p_sharedsecret NVARCHAR(255),
    p_b2bcustomerpunchoutcredentia BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE INDEX b2bcustomerpunchoutcredentiaRelIDX_10039 ON punchoutcredential (p_b2bcustomerpunchoutcredentia);
...
CREATE INDEX masterentryRelIDX_61 ON quoteentries (p_masterentry);
...
CREATE INDEX parentRelIDX_60 ON quotes (p_parent);
...
CREATE CACHED TABLE readcockpitcoll1710sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1710Sn ON readcockpitcoll1710sn (ITEMPK);

CREATE INDEX IdxsourcePK_1710Sn ON readcockpitcoll1710sn (sourcePK);

CREATE INDEX IdxtargetPK_1710Sn ON readcockpitcoll1710sn (targetPK);

CREATE INDEX IdxlanguagePK_1710Sn ON readcockpitcoll1710sn (languagePK);
...
CREATE CACHED TABLE readsavedqueryr1717sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1717Sn ON readsavedqueryr1717sn (ITEMPK);

CREATE INDEX IdxsourcePK_1717Sn ON readsavedqueryr1717sn (sourcePK);

CREATE INDEX IdxtargetPK_1717Sn ON readsavedqueryr1717sn (targetPK);

CREATE INDEX IdxlanguagePK_1717Sn ON readsavedqueryr1717sn (languagePK);
...
CREATE UNIQUE INDEX cmsItemByUidCvIDX_1074 ON restriction (p_uid, p_catalogversion);
...
CREATE CACHED TABLE sapuserverifito62sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_62Sn ON sapuserverifito62sn (ITEMPK);


CREATE CACHED TABLE sapuserverifitokens
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    tokencode LONGVARCHAR,
    p_tokenencoding NVARCHAR(255),
    p_uid NVARCHAR(255),
    p_verificationpurpose BIGINT,
    p_expirationtime TIMESTAMP,
    p_failedverificationattempts INTEGER,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE UNIQUE INDEX id_idx_62 ON sapuserverifitokens (tokenid);

CREATE INDEX id_purpose_idx_62 ON sapuserverifitokens (tokenid, p_verificationpurpose);

CREATE INDEX id_uid_purpose_idx_62 ON sapuserverifitokens (tokenid, p_uid, p_verificationpurpose);

CREATE INDEX uid_idx_62 ON sapuserverifitokens (p_uid);

CREATE INDEX expiration_time_idx_62 ON sapuserverifitokens (p_expirationtime);
...
CREATE UNIQUE INDEX cmsRelationByUidCvIdx_1071 ON slotsforpage (p_uid, p_catalogversion);

CREATE INDEX SlotsForPagePageIdx_1071 ON slotsforpage (p_page);
...
CREATE UNIQUE INDEX cmsRelationByUidCvIdx_1069 ON slotsfortemplate (p_uid, p_catalogversion);

CREATE INDEX SlotsForTempTempIdx_1069 ON slotsfortemplate (p_pagetemplate);
...
(
    ...
    p_id NVARCHAR(255),
    p_fieldtype BIGINT,
    p_valueprovider NVARCHAR(255),
    p_valueproviderparameters LONGVARBINARY,
    p_retrievable TINYINT,
    p_searchable TINYINT,
    p_searchtolerance BIGINT,
    p_localized TINYINT,
    p_qualifiertypeid NVARCHAR(255),
    p_multivalued TINYINT,
    p_useforspellchecking TINYINT,
    p_useforsuggesting TINYINT,
    p_weight FLOAT,
    p_indextypepos INTEGER,
    p_indextype BIGINT,
    aCLTS BIGINT DEFAULT 0,
...
CREATE CACHED TABLE snfield2263sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2263Sn ON snfield2263sn (ITEMPK);


CREATE CACHED TABLE snfieldlp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE snindex2266sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2266Sn ON snindex2266sn (ITEMPK);


CREATE CACHED TABLE snindexconf
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_user BIGINT,
    p_listeners LONGVARBINARY,
    p_searchproviderconfiguration BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE snindexconf2261sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2261Sn ON snindexconf2261sn (ITEMPK);


CREATE CACHED TABLE snindexconf2cur2271sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2271Sn ON snindexconf2cur2271sn (ITEMPK);

CREATE INDEX IdxsourcePK_2271Sn ON snindexconf2cur2271sn (sourcePK);

CREATE INDEX IdxtargetPK_2271Sn ON snindexconf2cur2271sn (targetPK);

CREATE INDEX IdxlanguagePK_2271Sn ON snindexconf2cur2271sn (languagePK);


CREATE CACHED TABLE snindexconf2currency
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snindexconf2lan2270sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2270Sn ON snindexconf2lan2270sn (ITEMPK);

CREATE INDEX IdxsourcePK_2270Sn ON snindexconf2lan2270sn (sourcePK);

CREATE INDEX IdxtargetPK_2270Sn ON snindexconf2lan2270sn (targetPK);

CREATE INDEX IdxlanguagePK_2270Sn ON snindexconf2lan2270sn (languagePK);


CREATE CACHED TABLE snindexconf2language
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snindexconf2syn2272sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2272Sn ON snindexconf2syn2272sn (ITEMPK);

CREATE INDEX IdxsourcePK_2272Sn ON snindexconf2syn2272sn (sourcePK);

CREATE INDEX IdxtargetPK_2272Sn ON snindexconf2syn2272sn (targetPK);

CREATE INDEX IdxlanguagePK_2272Sn ON snindexconf2syn2272sn (languagePK);


CREATE CACHED TABLE snindexconf2synonymdic
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snindexconflp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE snindexeritemsr2268sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2268Sn ON snindexeritemsr2268sn (ITEMPK);


CREATE CACHED TABLE snindexeritemsr2269sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2269Sn ON snindexeritemsr2269sn (ITEMPK);


CREATE CACHED TABLE snindexeritemsrc
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snindexeritemsrcop
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_documentoperationtype BIGINT,
    p_indexeritemsource BIGINT,
    p_cronjobpos INTEGER,
    p_cronjob BIGINT,
    aCLTS BIGINT DEFAULT 0,
...
CREATE CACHED TABLE snindexerop
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snindexerop2267sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2267Sn ON snindexerop2267sn (ITEMPK);


CREATE CACHED TABLE snindextype
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_identityproviderparameters LONGVARBINARY,
    p_defaultvalueprovider NVARCHAR(255),
    p_defaultvalueproviderparamete LONGVARBINARY,
    p_listeners LONGVARBINARY,
    p_indexconfigurationpos INTEGER,
    p_indexconfiguration BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE snindextype2262sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2262Sn ON snindextype2262sn (ITEMPK);


CREATE CACHED TABLE snindextype2cat2273sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2273Sn ON snindextype2cat2273sn (ITEMPK);

CREATE INDEX IdxsourcePK_2273Sn ON snindextype2cat2273sn (sourcePK);

CREATE INDEX IdxtargetPK_2273Sn ON snindextype2cat2273sn (targetPK);

CREATE INDEX IdxlanguagePK_2273Sn ON snindextype2cat2273sn (languagePK);


CREATE CACHED TABLE snindextype2cat2274sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2274Sn ON snindextype2cat2274sn (ITEMPK);

CREATE INDEX IdxsourcePK_2274Sn ON snindextype2cat2274sn (sourcePK);

CREATE INDEX IdxtargetPK_2274Sn ON snindextype2cat2274sn (targetPK);

CREATE INDEX IdxlanguagePK_2274Sn ON snindextype2cat2274sn (languagePK);


CREATE CACHED TABLE snindextype2catalog
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snindextype2catalogver
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snindextypelp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE sninditmsrcop2f2275sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2275Sn ON sninditmsrcop2f2275sn (ITEMPK);

CREATE INDEX IdxsourcePK_2275Sn ON sninditmsrcop2f2275sn (sourcePK);

CREATE INDEX IdxtargetPK_2275Sn ON sninditmsrcop2f2275sn (targetPK);

CREATE INDEX IdxlanguagePK_2275Sn ON sninditmsrcop2f2275sn (languagePK);


CREATE CACHED TABLE sninditmsrcop2field
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX linktarget_2275 ON sninditmsrcop2field (TargetPK);

CREATE INDEX rseqnr_2275 ON sninditmsrcop2field (RSequenceNumber);

CREATE INDEX qualifier_2275 ON sninditmsrcop2field (Qualifier);

CREATE INDEX linksource_2275 ON sninditmsrcop2field (SourcePK);

CREATE INDEX seqnr_2275 ON sninditmsrcop2field (SequenceNumber);


CREATE CACHED TABLE snsearchprovcon2260sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2260Sn ON snsearchprovcon2260sn (ITEMPK);


CREATE CACHED TABLE snsearchprovconf
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snsearchprovconflp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE snsynonymdic
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE snsynonymdic2264sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2264Sn ON snsynonymdic2264sn (ITEMPK);


CREATE CACHED TABLE snsynonymdiclp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE snsynonymentry
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_id NVARCHAR(255),
    p_input LONGVARBINARY,
    p_synonyms LONGVARBINARY,
    p_synonymdictionarypos INTEGER,
    p_synonymdictionary BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE snsynonymentry2265sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2265Sn ON snsynonymentry2265sn (ITEMPK);
...
CREATE CACHED TABLE storedpunchouts10055sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_10055Sn ON storedpunchouts10055sn (ITEMPK);


CREATE CACHED TABLE storedpunchoutsession
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_sid NVARCHAR(255),
    p_punchoutsession LONGVARBINARY,
    p_cart BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE UNIQUE INDEX sidLookup_10055 ON storedpunchoutsession (p_sid);
...
(
    ...
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    p_outboundchannelconfiguration BIGINT,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE subscriptions
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_description NVARCHAR(255),
    p_productcode NVARCHAR(255),
    p_ordernumber NVARCHAR(255),
    p_orderentrynumber INTEGER,
    p_billingsystemid NVARCHAR(255),
    p_startdate TIMESTAMP,
    p_enddate TIMESTAMP,
    p_renewaltype NVARCHAR(255),
    p_subscriptionstatus NVARCHAR(255),
    p_cancellable TINYINT,
    p_billingfrequency NVARCHAR(255),
    p_contractduration INTEGER,
    p_contractfrequency NVARCHAR(255),
    p_placedon TIMESTAMP,
    p_cancelleddate TIMESTAMP,
...
CREATE CACHED TABLE subscriptions6327sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6327Sn ON subscriptions6327sn (ITEMPK);


CREATE CACHED TABLE subscriptionter6323sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6323Sn ON subscriptionter6323sn (ITEMPK);


CREATE CACHED TABLE subscriptionterms
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_id NVARCHAR(255),
    p_termofservicenumber INTEGER,
    p_cancellable TINYINT,
    p_termofservicerenewal BIGINT,
    p_termofservicefrequency BIGINT,
    p_billingplan BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE subscriptiontermslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE INDEX BackofficeTheme_Code_6404 ON themes (p_code);


CREATE CACHED TABLE themes6404sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6404Sn ON themes6404sn (ITEMPK);


CREATE CACHED TABLE themeslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE usagecharges
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_catalogversion BIGINT,
    p_usageunit BIGINT,
    p_subscriptionpriceplanusage BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    p_usagechargetype BIGINT,
    PRIMARY KEY (PK)
);

CREATE INDEX versionIdx_6322 ON usagecharges (p_catalogversion);

CREATE INDEX idVersionIdx_6322 ON usagecharges (p_id, p_catalogversion);

CREATE INDEX subscriptionpriceplanusageRelIDX_6322 ON usagecharges (p_subscriptionpriceplanusage);


CREATE CACHED TABLE usagecharges6322sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6322Sn ON usagecharges6322sn (ITEMPK);


CREATE CACHED TABLE usagechargeslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE usageunits
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE usageunits6326sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6326Sn ON usageunits6326sn (ITEMPK);


CREATE CACHED TABLE usageunitslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
    p_name NVARCHAR(255),
    p_nameplural NVARCHAR(255),
    PRIMARY KEY (ITEMPK, LANGPK)
);
...
CREATE CACHED TABLE webhookconfigs
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX idx_eventConfigIntObjDestination_8414 ON webhookconfigs (p_eventtype, p_integrationobject, p_destination);


CREATE CACHED TABLE webhookconfigs8414sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8414Sn ON webhookconfigs8414sn (ITEMPK);


CREATE CACHED TABLE webhookpayloads
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE webhookpayloads8415sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8415Sn ON webhookpayloads8415sn (ITEMPK);
...
CREATE CACHED TABLE widgetparameter2072sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2072Sn ON widgetparameter2072sn (ITEMPK);


CREATE CACHED TABLE widgetpreferenc2071sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2071Sn ON widgetpreferenc2071sn (ITEMPK);
...
CREATE CACHED TABLE wishlist2701sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_701Sn ON wishlist2701sn (ITEMPK);


CREATE CACHED TABLE wishlist2entry
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE wishlist2entry702sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_702Sn ON wishlist2entry702sn (ITEMPK);
...
CREATE CACHED TABLE writecockpitcol1711sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1711Sn ON writecockpitcol1711sn (ITEMPK);

CREATE INDEX IdxsourcePK_1711Sn ON writecockpitcol1711sn (sourcePK);

CREATE INDEX IdxtargetPK_1711Sn ON writecockpitcol1711sn (targetPK);

CREATE INDEX IdxlanguagePK_1711Sn ON writecockpitcol1711sn (languagePK);
