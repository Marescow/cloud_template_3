...
public interface YFormService
{
	...
	/**
	 * Create or update YFormDefinition with specific parameters.
	 *
	 * @param applicationId
	 * 			the application id of the form definition, should exist in a catalog
	 * @param formId
	 ...
	 * @throws YFormServiceException if form definition cannot be created
	 */
	default YFormDefinitionModel createOrUpdateYFormDefinition(final String applicationId, final String formId, final String title,
			final String description, final String content, final String documentId, final String version) throws YFormServiceException
	{
