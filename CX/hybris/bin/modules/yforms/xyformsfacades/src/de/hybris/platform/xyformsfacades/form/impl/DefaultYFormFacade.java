...
public class DefaultYFormFacade implements YFormFacade
{
	...
	@Override
	public YFormDefinitionData createOrUpdateYFormDefinition(final String applicationId, final String formId, final String content,
			final String documentId, final String version) throws YFormServiceException
	{
		...
		final YFormDefinitionModel yFormDefinition = yformService.createOrUpdateYFormDefinition(applicationId, formId, title, description,
				content, documentId, version);
		return yformDefinitionConverter.convert(yFormDefinition);
	}
