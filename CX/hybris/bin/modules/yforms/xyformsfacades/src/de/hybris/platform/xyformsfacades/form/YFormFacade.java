...
public interface YFormFacade
{
	...
	/**
	 * Create or update a YFormDefinition with specific parameters.
	 *
	 * @param applicationId
	 * 			the application id of the form definition
	 * @param formId
	 ...
	 * @return created or updated form definition POJO
	 * @throws YFormServiceException if form definition cannot be created or updated
	 */
	default YFormDefinitionData createOrUpdateYFormDefinition(final String applicationId, final String formId, final String content,
			final String documentId, final String version) throws YFormServiceException
	{
		throw new UnsupportedOperationException("Method createOrUpdateYFormDefinition is not implemented");
	}
