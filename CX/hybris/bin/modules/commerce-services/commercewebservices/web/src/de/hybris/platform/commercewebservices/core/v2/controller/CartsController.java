...
public class CartsController extends BaseCommerceController
{
	...
	/**
	 * @deprecated since 2205.27, please use {@link #setEmail(SAPGuestUserRequestWsDTO)} instead
	 */
	@Deprecated(since = "2205.27", forRemoval = true)
	@Secured({ "ROLE_CLIENT", "ROLE_TRUSTED_CLIENT" })
	@PutMapping(value = "/{cartId}/email")
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "replaceCartGuestUser", value = "Assigns an email address to the cart.",
			notes = "Assigns an email to the cart. This endpoint is deprecated in the 2205.27 and its deletion is planned. Please use '/setEmail' instead.")
	@ApiBaseSiteIdUserIdAndCartIdParam
	...
	@ApiOperation(nickname = "setGuestUserEmail", value = "Assigns an email address to the cart.", notes = "Assigns an email to the cart. This endpoint is introduced in the 2205.27.")
	@ApiBaseSiteIdUserIdAndCartIdParam
