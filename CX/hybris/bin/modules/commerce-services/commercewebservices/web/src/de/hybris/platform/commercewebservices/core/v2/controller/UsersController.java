...
public class UsersController extends BaseCommerceController
{
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "replaceUserLogin", value = "Changes customer's login name. It's deprecated, use POST method instead.", notes = "Changes a customer's login name. Requires the customer's current password.")
	@ApiBaseSiteIdAndUserIdParam
	...
	@ApiOperation(nickname = "replaceUserPassword", value = "Changes customer's password", notes = "Changes customer's password. It's deprecated, use POST method instead.")
	@ApiBaseSiteIdAndUserIdParam
	public void replaceUserPassword(
			@ApiParam(value = "User identifier.", required = true) @PathVariable final String userId,
			@ApiParam(value = "Old password.", required = true) @RequestParam(value = "old") final String old,
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "changeUserLoginId", value = "Changes customer's login id.", notes = "Changes a customer's login id. Requires the customer's current password.")
	@ApiBaseSiteIdAndUserIdParam
	...
	@ApiOperation(nickname = "changeUserPassword", value = "Updates the password of a customer. ")
	@ApiBaseSiteIdAndUserIdParam
