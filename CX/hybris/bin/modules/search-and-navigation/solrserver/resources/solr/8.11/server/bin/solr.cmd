...
IF "%SOLR_JETTY_HOST%"=="" (
  @REM Workaround for https://issues.apache.org/jira/browse/SOLR-13985
...
@REM Workaround for https://issues.apache.org/jira/browse/SOLR-13985 - start
) ELSE IF "%SOLR_JETTY_HOST%"=="" (
  set "SOLR_HOST_ARG=-Dhost=localhost"
) ELSE IF "%SOLR_JETTY_HOST%"=="127.0.0.1" (
  set "SOLR_HOST_ARG=-Dhost=localhost"
@REM Workaround for https://issues.apache.org/jira/browse/SOLR-13985 - end
) ELSE (
  set SOLR_HOST_ARG=
)
