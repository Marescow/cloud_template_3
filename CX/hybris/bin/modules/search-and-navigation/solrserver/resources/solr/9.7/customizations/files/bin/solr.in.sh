...
# default - Settings without ZK ACL
SOLR_ZK_CREDS_AND_ACLS="-DzkACLProvider=org.apache.solr.common.cloud.DefaultZkACLProvider \
...
#  -DzkCredentialsProvider=org.apache.solr.common.cloud.DigestZkCredentialsProvider \
#  -DzkCredentialsInjector=org.apache.solr.common.cloud.VMParamsZkCredentialsInjector \
#  -DzkDigestCredentialsFile=$DEFAULT_SERVER_DIR/etc/zookeepercredentials.properties"

SOLR_OPTS="$SOLR_OPTS $SOLR_ZK_CREDS_AND_ACLS"

# default replica placement plugin to use if one is not configured in cluster properties or solr.xml
#SOLR_PLACEMENTPLUGIN_DEFAULT=simple

# https://solr.apache.org/guide/solr/latest/configuration-guide/configuring-solr-xml.html#the-replicaplacementfactory-element
# To allow definition of replica placement plugin in solr.xml, the solr.cluster.plugin.edit.enabled System Property must be set to false
#SOLR_OPTS="$SOLR_OPTS -Dsolr.cluster.plugin.edit.enabled=false"
