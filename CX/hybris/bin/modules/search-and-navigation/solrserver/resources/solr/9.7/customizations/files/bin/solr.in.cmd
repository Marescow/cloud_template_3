...
set SOLR_REQUESTLOG_ENABLED=false
...
REM  -DzkCredentialsProvider=org.apache.solr.common.cloud.DigestZkCredentialsProvider ^
REM  -DzkCredentialsInjector=org.apache.solr.common.cloud.VMParamsZkCredentialsInjector ^
REM  -DzkDigestCredentialsFile=%SOLR_SERVER_DIR%/etc/zookeepercredentials.properties

REM default replica placement plugin to use if one is not configured in cluster properties or solr.xml
REM set SOLR_PLACEMENTPLUGIN_DEFAULT=simple

REM https://solr.apache.org/guide/solr/latest/configuration-guide/configuring-solr-xml.html#the-replicaplacementfactory-element
REM To allow definition of replica placement plugin in solr.xml, the solr.cluster.plugin.edit.enabled System Property must be set to false
REM SOLR_OPTS="$SOLR_OPTS -Dsolr.cluster.plugin.edit.enabled=false"
