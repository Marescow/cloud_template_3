...
public class CustomerHelper
{
	...
	public CustomerSuggestionsResponseWsDTO getCustomerSuggestionsResponse(final List<AutoSuggestionCustomerData> customerData)
	{
		List<CustomerSuggestionWsDto> suggestions = dataMapper.mapAsList(customerData, CustomerSuggestionWsDto.class,
				FieldSetLevelHelper.DEFAULT_LEVEL);

		CustomerSuggestionsResponseWsDTO response = new CustomerSuggestionsResponseWsDTO();
