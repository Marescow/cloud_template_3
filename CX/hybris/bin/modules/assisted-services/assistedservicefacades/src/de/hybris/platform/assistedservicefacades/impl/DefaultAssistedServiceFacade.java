...
public class DefaultAssistedServiceFacade implements AssistedServiceFacade
{
	...
	private Converter<CustomerModel, CustomerData> customerToCustomerConverter;
	...
	@Override
	public SearchPageData<CustomerData> getPagedCustomers(final String searchTerm, final PageableData pageableData)
	{
		final SearchPageData<CustomerModel> customers = assistedServiceService.getCustomers(searchTerm, pageableData);
		return CommerceUtils.convertPageData(customers, getCustomerToCustomerConverter());
	}
	...
	protected Converter<CustomerModel, CustomerData> getCustomerToCustomerConverter()
	{
		return customerToCustomerConverter;
	}

	public void setCustomerToCustomerConverter(final Converter<CustomerModel, CustomerData> customerToCustomerConverter)
	{
		this.customerToCustomerConverter = customerToCustomerConverter;
	}
