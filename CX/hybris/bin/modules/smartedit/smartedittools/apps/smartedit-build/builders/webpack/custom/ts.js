 ...
 * @param {boolean} enableHappyPack To enable thread loader (must be false when using generateWebpack since serialize-javascript not compatible).
 *
    ...
    group(
        rule({
            ...
            use: [
                ...
                ...(cache && enableHappyPack ? [cacheLoader] : []),
                {
                    loader: 'ts-loader',
                    /**
