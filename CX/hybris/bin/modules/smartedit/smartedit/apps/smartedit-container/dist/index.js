...
/* @ngInject */ exports.SessionService = class /* @ngInject */ SessionService extends smarteditcommons.ISessionService {
    ...
    hasUserChanged() {
        ...
        return prevHashPromise.then((prevHash) => this.whoAmIService
            ...
            prevHash !== this.cryptographicUtils.sha512Hash(currentUserData.uid)));
    }
    setCurrentUsername() {
        return this.whoAmIService.get({}).then((currentUserData) => {
            ...
            this.cachedUserHash = this.cryptographicUtils.sha512Hash(currentUserData.uid);
...
let /* @ngInject */ ConfigurationService = class /* @ngInject */ ConfigurationService {
    ...
    removeEntry(entry, configurationForm) {
        if (entry.isNew) {
            this.configuration = this.configuration.filter((confEntry) => confEntry.uuid !== entry.uuid);
        }
        else {
            configurationForm.form.markAsDirty();
            const NewSameKeyEntry = this.configuration.find((confEntry) => confEntry.isNew && confEntry.key === entry.key);
            if (!!NewSameKeyEntry) {
    ...
    filterErrorConfiguration() {
        return (this.configuration || []).filter((instance) => instance.hasErrors && !instance.toDelete);
    }
    ...
    findDuplicateKeyConfiguration() {
        return this.configuration.reduce((confHolder, nextConfiguration) => {
...
let ConfigurationModalComponent = class ConfigurationModalComponent {
    constructor(editor, modalManager, confirmationModalService) {
        ...
        this.isConfigurationsAvailable = false;
    }
    ngOnInit() {
        this.editor.init();
        this.isConfigurationsAvailable = true;
        this.form.statusChanges.subscribe(() => {
            if (!this.formIsInvalid() && this.form.dirty) {
    ...
    formIsInvalid() {
        return this.editor.filterErrorConfiguration().length > 0;
    }
    trackByFn(_, item) {
        return item.uuid;
    }
    ...
    onSave() {
        return this.editor.submit(this.form).then(() => {
            ...
            return Promise.reject('Can not save configuration.');
        });
    }
};
__decorate([
...
UserTrackingService.$inject = ["windowUtils", "settingService", "logService"];
/* @ngInject */ UserTrackingService = __decorate([
    smarteditcommons.SeDowngradeService(smarteditcommons.IUserTrackingService),
                        ...
                        smartEditHeaderToolbarService.addItems([
                            {
                                ...
                                callback: () => {
                                    window.open('https://help.sap.com/docs/SAP_COMMERCE_CLOUD_PUBLIC_CLOUD/e1391e5265574bfbb56ca4c0573ba1dc/ec55cb76fa804569a4d23f05c58d6b72.html?version=v2205', '', 'noopener');
                                },
                                priority: 6,
