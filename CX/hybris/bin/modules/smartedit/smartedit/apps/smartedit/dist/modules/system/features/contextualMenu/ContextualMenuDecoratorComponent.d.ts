...
import { ComponentAttributes, IContextualMenuButton, IContextualMenuService, NodeUtils, PopupOverlayConfig, SystemEventService, ComponentHandlerService, CrossFrameEventService, IUserTrackingService } from 'smarteditcommons';
...
export declare class ContextualMenuDecoratorComponent extends BaseContextualMenuComponent implements OnInit, DoCheck, OnDestroy {
    ...
    constructor(yjQuery: JQueryStatic, element: ElementRef, contextualMenuService: IContextualMenuService, systemEventService: SystemEventService, componentHandlerService: ComponentHandlerService, nodeUtils: NodeUtils, crossFrameEventService: CrossFrameEventService, userTrackingService: IUserTrackingService);
    ngDoCheck(): void;
    ngOnDestroy(): void;
    ngOnInit(): void;
