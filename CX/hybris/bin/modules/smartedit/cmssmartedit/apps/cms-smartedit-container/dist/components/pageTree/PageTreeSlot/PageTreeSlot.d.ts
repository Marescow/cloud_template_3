...
import { IPageTreeNodeService, LogService, IUserTrackingService } from 'smarteditcommons';
...
export declare class PageTreeSlot {
    ...
    constructor(pageTreeNodeService: IPageTreeNodeService, nodeInfoService: NodeInfoService, logService: LogService, userTrackingService: IUserTrackingService);
