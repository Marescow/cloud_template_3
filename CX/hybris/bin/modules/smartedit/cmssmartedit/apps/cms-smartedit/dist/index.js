...
let SlotSyncButtonComponent = class SlotSyncButtonComponent {
    ...
    ngDoCheck() {
        ...
        if (this.popoverOverlay && this.isPopupOpened && !this.subscriptionTag) {
            this.popoverIsOpenChangeSubscription = this.popoverOverlay.popover.isOpenChange.subscribe((isOpen) => {
                if (isOpen) {
                    this.interval = setInterval(() => this.popoverOverlay.popover.updatePopover(), INTERVAL_TIME);
...
__decorate([
    core.ViewChild(smarteditcommons.PopupOverlayComponent, { static: false }),
    __metadata("design:type", smarteditcommons.PopupOverlayComponent)
], SlotSyncButtonComponent.prototype, "popoverOverlay", void 0);
...
/* @ngInject */ exports.SlotContainerService = class /* @ngInject */ SlotContainerService {
    ...
    getComponentContainer(slotId, componentUuid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let containers = [];
            if ((containersInPage === null || containersInPage === void 0 ? void 0 : containersInPage.length) > 0) {
                containers = containersInPage.filter((container) => container.slotId === slotId && lodash.includes(container.components, componentUuid));
            }
...
window.__smartedit__.addDecoratorPayload("Component", "SlotVisibilityComponent", {
    ...
    styles: [`.se-slot-visiblity-component--globe-icon{margin-left:4px}.se-slot-visiblity-component__content{display:flex;flex-direction:row;align-items:center;flex-grow:1}.se-slot-visiblity-component__description{margin-right:16px;max-width:400px}.se-slot-visiblity-component__name,.se-slot-visiblity-component__visibility{color:#32363a}.se-slot-visiblity-component__name--link{cursor:pointer;color:#0a6ed1;width:100%;overflow:hidden;text-overflow:ellipsis}.se-slot-visiblity-component__type{color:#6a6d70}`],
    changeDetection: core.ChangeDetectionStrategy.OnPush
});
...
exports.CmssmarteditModule = __decorate([
    ...
    core.NgModule({
        ...
        providers: [
            ...
            smarteditcommons.moduleUtils.bootstrap((contextualMenuDropdownService, editorEnablerService, decoratorService, featureService, componentHandlerService, slotRestrictionsService, pageInfoService, typePermissionsRestService, cmsDragAndDropService, slotSharedService, storageService, openNodeInPageTreeService, componentMenuConditionAndCallbackService) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const pageTreeEnabled = yield storageService.getValueFromLocalStorage('PAGETREE_ENABLED', true);
