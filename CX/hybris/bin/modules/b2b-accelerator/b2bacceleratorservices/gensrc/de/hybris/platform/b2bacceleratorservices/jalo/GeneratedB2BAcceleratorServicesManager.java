...
import de.hybris.platform.b2b.jalo.restrictions.CMSSecurePortalRestriction;
...
public abstract class GeneratedB2BAcceleratorServicesManager extends Extension
{
	...
	**/
	...
	public CMSSecurePortalRestriction createCMSSecurePortalRestriction(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( B2BAcceleratorServicesConstants.TC.CMSSECUREPORTALRESTRICTION );
