...
public class GeneratedSearchservicesConstants
{
	...
	public static class TC
	{
		...
		public static final String SNSEARCHTOLERANCE = "SnSearchTolerance".intern();
	...
	public static class Enumerations
	{
		...
		public static class SnDocumentOperationType
		{
			...
			public static final String PARTIAL_UPDATE = "PARTIAL_UPDATE".intern();
		...
		public static class SnSearchTolerance
		{
	...
	public static class Relations
	{
		...
		public static final String SNINDEXERITEMSOURCEOPERATION2FIELD = "SnIndexerItemSourceOperation2Field".intern();
