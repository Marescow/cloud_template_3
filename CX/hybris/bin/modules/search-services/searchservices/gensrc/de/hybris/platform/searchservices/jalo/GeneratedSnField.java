...
public abstract class GeneratedSnField extends GenericItem
{
	...
	/** Qualifier of the <code>SnField.searchTolerance</code> attribute **/
	...
	/** Qualifier of the <code>SnField.indexerItemSourceOperations</code> attribute **/
	...
	**/
	...
	static
	{
		...
		tmp.put(SEARCHTOLERANCE, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SnField.indexerItemSourceOperations</code> attribute.
	...
	{
		final List<SnIndexerItemSourceOperation> items = getLinkedItems( 
			ctx,
			false,
	...
	public long getIndexerItemSourceOperationsCount(final SessionContext ctx)
	{
	...
	{
		return getIndexerItemSourceOperationsCount( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>SnField.indexerItemSourceOperations</code> attribute. 
	...
	{
		ComposedType relationSecondEnd0 = TypeManager.getInstance().getComposedType("SnIndexerItemSourceOperation");
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SnField.searchTolerance</code> attribute.
	 * @return the searchTolerance
	 */
	public EnumerationValue getSearchTolerance(final SessionContext ctx)
	{
		return (EnumerationValue)getProperty( ctx, SEARCHTOLERANCE);
	}
	...
	{
		return getSearchTolerance( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>SnField.searchTolerance</code> attribute. 
	 * @param value the searchTolerance
	 */
	public void setSearchTolerance(final SessionContext ctx, final EnumerationValue value)
	{
		setProperty(ctx, SEARCHTOLERANCE,value);
	}
	 ...
	 * @param value the searchTolerance
	 */
	public void setSearchTolerance(final EnumerationValue value)
	{
		setSearchTolerance( getSession().getSessionContext(), value );
	}
