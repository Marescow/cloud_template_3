...
public class CustomerCouponAssignmentPanelRenderer extends DefaultEditorAreaPanelRenderer
{
	...
	private static final String LABEL_DESCRIPTION = "type.CustomerCoupon.campaignURL.description";
			...
			final String qualifier, final Div div)
	{
		...
		final Div labelTitle = new Div();
		labelTitle.appendChild(label);
		labelTitle.setStyle("display: flex");
		attributeDescriptionIconRenderer.renderDescriptionIcon(Localization
				.getLocalizedString(LABEL_DESCRIPTION), labelTitle);
		cell.appendChild(labelTitle);
