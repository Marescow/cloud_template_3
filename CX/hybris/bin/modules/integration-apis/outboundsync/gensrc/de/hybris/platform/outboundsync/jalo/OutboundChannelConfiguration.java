...
public class OutboundChannelConfiguration extends GenericItem
{
	...
	/** Qualifier of the <code>OutboundChannelConfiguration.synchronizeDelete</code> attribute **/
	...
	static
	{
		...
		tmp.put(SYNCHRONIZEDELETE, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>OutboundChannelConfiguration.synchronizeDelete</code> attribute.
	 ...
	 */
	public Boolean isSynchronizeDelete(final SessionContext ctx)
	{
		return (Boolean)getProperty( ctx, "synchronizeDelete".intern());
	}
	...
	{
		return isSynchronizeDelete( getSession().getSessionContext() );
	}
	 ...
	 *                         will be ignored. Default value is false.
	 */
	public boolean isSynchronizeDeleteAsPrimitive(final SessionContext ctx)
	{
		Boolean value = isSynchronizeDelete( ctx );
		return value != null ? value.booleanValue() : false;
	}
	...
	{
		return isSynchronizeDeleteAsPrimitive( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>OutboundChannelConfiguration.synchronizeDelete</code> attribute. 
	 ...
	 *                         will be ignored. Default value is false.
	 */
	public void setSynchronizeDelete(final SessionContext ctx, final Boolean value)
	{
		setProperty(ctx, "synchronizeDelete".intern(),value);
	}
	...
	{
		setSynchronizeDelete( getSession().getSessionContext(), value );
	}
	...
	public void setSynchronizeDelete(final SessionContext ctx, final boolean value)
	{
		setSynchronizeDelete( ctx,Boolean.valueOf( value ) );
	}
