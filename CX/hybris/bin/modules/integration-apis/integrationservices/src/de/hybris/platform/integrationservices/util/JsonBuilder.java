...
public final class JsonBuilder
{
	 ...
	 */
	@SafeVarargs
	public final JsonBuilder withLocalizedAttributes(final Map<String, ?>... attributes)
	{
	...
	/**
	 * Specifies field for the JSON output.
	 *
	 * @param field JSON attribute to be present in the generated JSON.
	 * @param value value the attribute should have in the generated JSON.
	 * @return a builder with the field specified.
	 */
	public JsonBuilder withField(final String field, final Object value)
	{
		fields.put(field, value);
		return this;
	}
	...
	private String mapValue(final Map<?, ?> m)
	{
		...
		m.forEach((k, v) -> jsonBuilder.withField(k.toString(), v));
