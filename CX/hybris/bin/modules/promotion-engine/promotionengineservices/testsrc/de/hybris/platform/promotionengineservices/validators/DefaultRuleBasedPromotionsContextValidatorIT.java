...
public class DefaultRuleBasedPromotionsContextValidatorIT extends ServicelayerTest
{
	...
	@Test
	public void shouldExcludeProductWhenMatchPromotionExcludedProduct()
	{
		//given
		final RuleBasedPromotionModel promotion = findRuleBasedPromotion("exclude-product");
		final ProductModel excludedProduct = productService.getProductForCode("excludedProduct");

		//when then
		Assert.assertTrue(validator.isExcludedProduct(promotion, excludedProduct));
	}
