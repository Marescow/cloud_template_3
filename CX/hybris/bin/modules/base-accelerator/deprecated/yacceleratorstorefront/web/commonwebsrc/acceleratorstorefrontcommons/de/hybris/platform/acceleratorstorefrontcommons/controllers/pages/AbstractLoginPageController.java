...
public abstract class AbstractLoginPageController extends AbstractRegisterPageController
{
	...
	protected static final String OTP_USERNAME_CHANGED = "OTP_USERNAME_CHANGED";
			...
			throws CMSItemNotFoundException
	{
		...
		if (loginError)
		{
			...
			final Boolean usernameChanged = (Boolean) session.getAttribute(OTP_USERNAME_CHANGED);
			if (usernameChanged != null)
			{
				session.removeAttribute(OTP_USERNAME_CHANGED);
			}
