...
public class StrategyControllerTest extends StrategyTest
{
	...
	{
		final StrategyListWsDTO allStrategies = controller.getAllStrategies(null, null);
		for (int i = 0; i < 9; i++)
		{
		...
		final StrategyListWsDTO pagedStrategies = controller.getAllStrategies(Integer.valueOf(1), Integer.valueOf(16));
		for (int i = 0; i < 15; i++)
		{
	...
	public void testPaginationForLastPage()
	{
		...
		//when
		final StrategyListWsDTO strategies = controller.getAllStrategies(currentPage, pageSize);
