...
public class CategoryRuleParameterValueMapperTest
{
	...
	public void mappedCatalogAwareCategoryTest()
	{
		...
		Mockito.lenient().when(catalog.getCatalogVersions()).thenReturn(catalogVersions);
		Mockito.lenient().when(categoryDao.findCategoriesByCode(catalogVersion, CATEGORY_CODE)).thenReturn(categories);
