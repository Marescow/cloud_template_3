...
public class AbstractClassificationAttributeTranslatorTest
{
	...
	public void setUp()
	{
		given(abstractClassificationAttributeTranslator.getClassificationService()).willReturn(classificationService);
	...
	@Test
	public void shouldReturnEmptyWhenFeatureIsNull()
	{
		//given
		doReturn(null).when(classificationService).getFeature(any(), any());

		//when
		final Optional<String> result = abstractClassificationAttributeTranslator.exportData(mock(ExcelClassificationAttribute.class), mock(ProductModel.class));
