...
public class DefaultTypeSystemLocalizationHelperTest
{
	...
	public static final String ISO_DE = "de_DE";
	...
	public void setUp()
	{
		doReturn(List.of(en, esCo, de)).when(cockpitLocaleService).getAllUILocales();
	...
	public void shouldLoadLocalizationOnFirstLocalizeType()
	{
		final SearchResult mock = new SearchResultImpl(List.of(List.of(ProductModel._TYPECODE, ISO_EN, "enProduct"),
				List.of(ProductModel._TYPECODE, ISO_ES_CO, "es_COProduct"), Lists.newArrayList(ProductModel._TYPECODE, ISO_DE, null)),
				3, 3, 0);
		...
		assertThat(captor.getValue()).containsKeys(en, esCo, de);
		assertThat(captor.getValue()).containsValues("enProduct", "es_COProduct", StringUtils.EMPTY);
	}
